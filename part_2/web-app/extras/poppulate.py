...
def add_sample_data():
    ...
    sample_judges = [
        ...
        ("gsaivennela2017@gmail.com", "Sai Gmail", json.dumps(["Poster100", "Poster101"])),
        # ("sgowredd@syr.edu", "Vennela", json.dumps(["Poster 5", "Poster 6", "Poster 7", "Poster 8", "Poster 9", "Poster 10"]))
    ]
    cursor.executemany(
