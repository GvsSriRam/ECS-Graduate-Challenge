...
password = "7$Supercool"
server.login("preetamkamal@outlook.com",password)

body = "dear"+name+","+"\n"+"\n"+"your OTP is "+str(OTP)+"."
subject = "OTP verification using python"
message = f'subject:{subject}\n\n{body}'

server.sendmail("preetamkamal@outlook.com",valid_receiver_email,message)
...
def sending_otp(receiver_email):
    ...
    subject = "OTP verification using python" 
    message = f'subject:{subject}\n\n{body}'
    server.sendmail("nishinarayan420@gmail.com",receiver_email,message)
